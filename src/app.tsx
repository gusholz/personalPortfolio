...
import Sessao from '../src/components/sessao/sessao';
...
export default function App () {
    ...
    <div className={styles.wrapper}>
        ...
        <Sessao titulo='Desmotivado na quarentena,comecei a estudar programação' subtitulo='entre Backend e Front-end, definitivamente Front-End' nomeGif={`quarto`}>
        ...
        <Sessao titulo='Hoje, fico extremamente feliz com essa decisão, pois compreendo o' subtitulo='Design como ponte entre usuário e tecnologia' nomeGif={`quarto`}>
